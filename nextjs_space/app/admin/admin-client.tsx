      ...
      <Card className="bg-white shadow-lg">
        <CardHeader>
          <CardTitle className="flex items-center">
            <Database className="h-5 w-5 mr-2 text-bg-primary-600" />
            Data Export Tools
          </CardTitle>
          <CardDescription>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-2">
                <FileText className="h-4 w-4 text-bg-primary-600" />
          ...
          <div className="mt-6 p-4 bg-primary50 rounded-lg">
            <h4 className="font-semibold text-bg-primary-800 mb-2">Export Contents Include:</h4>
            <ul className="text-sm text-bg-primary-700 space-y-1">
